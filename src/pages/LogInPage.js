...
function LogInPage() {
  ...
  const submitStyle =
    "rounded-xl p-2 border-2 border-[#a0969d] bg-[#6e42d7] shadow-xl w-full text-white cursor-pointer hover:bg-[#7c5ac7]";
        ...
        <div>
          ...
          <div>
            <button className={btnStyle}>
              <img src={googleIcon} className="mr-3" />
              Authorize with Google{" "}
            </button>
            <button className={btnStyle}>
              <img src={microsoftIcon} className="mr-3" />
